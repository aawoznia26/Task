...
public class TrelloClientTest {
    ...
    public void init() {
        ...
        when(trelloConfig.getTrelloUserName()).thenReturn("aawozniak");
    ...
    public void shouldFetchTrelloBoards() throws URISyntaxException {
        ...
        URI uri = new URI("http://test.com/members/aawozniak/boards?key=test&token=test&fields=name,id&lists=all");
    ...
    public void shouldCreateCard() throws URISyntaxException {
        ...
        TrelloBadgesDto bages = new TrelloBadgesDto(1, attachmentsDto);
